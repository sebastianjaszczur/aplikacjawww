...
urlpatterns = [
    ...
    url(r'^updateProfilePage/$', views.update_profile_page_view, name='update_profile_page'),
    url(r'^updateCoverLetter/$', views.update_cover_letter_view, name='update_cover_letter'),
    url(r'^updateUserInfo/$', views.update_user_info_view, name='update_user_info'),
    ...
    url(r'^peopleInfo/$', views.people_info_view, name='peopleInfo'),
