...
urlpatterns = patterns('',
    ...
    url(r'^register/(?P<workshop_name>[a-zA-Z0-9\-_]+)/$', views.register_to_workshop, name='register_to_workshop'),
    url(r'^unregsiter/(?P<workshop_name>[a-zA-Z0-9\-_]+)/$', views.unregister_from_workshop, name='unregister_from_workshop'),
