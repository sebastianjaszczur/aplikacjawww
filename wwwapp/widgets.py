...
DEFAULT_CONFIG = {
    ...
    # contextmenu is removed, because it's annoying (and it replaces better
    # browser contextmenu) scayt,liststyle,tabletools are removed, because
    # they require contextmenu forms is removed, because there is no use-case
    # for it language is removed, because it's useless (it sets language of
    # content, by the way) print,preview,newpage are removed, because they're
    # useless bidi is removed, because it's completely useless (it changes
    # direction of text) flash,iframe are removed, because they're dangerous
